...
class Preprocessing:
    ...
    def __init__(self, dataframe: pd.DataFrame, scaler=None, imputer_num=None, imputer_cat=None, colonne_eliminate=None, lista_colonne=None, is_train=True):
    ...
    def esegui(self) -> pd.DataFrame:
        ...
        # FASE 3: ENCODING
        print(f"\n[FASE 3/4] Encoding variabili categoriche...")
        ...
        print(f"\n[FASE 4/4] Standardizzazione variabili continue...")
